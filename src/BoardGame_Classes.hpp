...
public:
   ...
   virtual void display_board() = 0;
    ...
    virtual bool update_rule(int x, int y) = 0;
...
///////////////////////////////////////////
// This class represent a 5 x 5 board
...
class X_O_4_Board: public Board {
public:
   X_O_4_Board();
   bool update_board(int x, int y, char mark);
   void display_board();
...
// class PlayerR : protected Player {
// public:
//     protected:
//         string name;
//         char symbol;
...
//         // Optionally, you can give him ID or order
//         // Like Player 1 and Player 2
//         PlayerR (char symbol); // Needed for computer players
//         PlayerR (int order, char symbol);
//         // Get desired move: x y (each between 0 and 2)
//         // Virtual (can change for other player types)
//         virtual void get_move(int& x, int& y);
//         // Give player info as a string
...
// class RandomPlayerR : public PlayerR {
    
//     protected:
//         int dimension;
//     public:
//         // Take a symbol and pass it to parent
//         RandomPlayerR (char symbol, int dimension);
//         // Generate a random move
//         void get_move(int& x, int& y);
// };
